...
- Keep the Python package and installed Godot plugin releases aligned. The `capabilities` tool reports compatibility data, active mode, exposed tools, optional features, and effective limits.
