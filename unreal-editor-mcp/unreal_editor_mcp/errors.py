...
class ErrorCode(str, Enum):
    ...
    REFERENCE_PREFLIGHT_FAILED = "reference_preflight_failed"
    REFERENCE_PREFLIGHT_INCOMPLETE = "reference_preflight_incomplete"
    UNSUPPORTED_ASSET = "unsupported_asset"
    MULTI_ASSET_PACKAGE = "multi_asset_package"
    STORAGE_UNAVAILABLE = "storage_unavailable"
    DIRTY_PACKAGE = "dirty_package"
    ASSET_EDITOR_OPEN = "asset_editor_open"
