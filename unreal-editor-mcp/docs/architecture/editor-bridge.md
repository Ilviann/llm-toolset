...
- The route accepts POST at `/unreal-mcp/v1/command`; the command allowlist contains the nineteen model-facing commands released through `asset-delete` plus internal `editor_shutdown`.
