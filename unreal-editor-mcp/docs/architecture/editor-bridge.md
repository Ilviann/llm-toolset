...
- The route accepts POST at `/unreal-mcp/v1/command`; the command allowlist contains the eighteen commands released through `asset-references` plus internal `editor_shutdown`.
