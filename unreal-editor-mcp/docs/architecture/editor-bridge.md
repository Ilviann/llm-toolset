...
- The route accepts POST at `/unreal-mcp/v1/command`; the command allowlist contains the twenty model-facing commands released through `widget-tree` plus internal `editor_shutdown`.
