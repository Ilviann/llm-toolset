...
- The route accepts POST at `/unreal-mcp/v1/command`; the command allowlist contains the twenty-four model-facing commands released through `level-edit` plus internal `editor_shutdown`.
