...
- The route accepts POST at `/unreal-mcp/v1/command`; the command allowlist contains the twenty-one model-facing commands released through `level-inspect` plus internal `editor_shutdown`.
