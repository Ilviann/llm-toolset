...
- Capabilities publish a bounded ten-record base family/operation matrix. Discovery records and all exact-asset operation results report `blueprint_family`; exact inspection also reports live default, component, widget-tree, event-graph, local-variable, override, and graph-type capabilities.
