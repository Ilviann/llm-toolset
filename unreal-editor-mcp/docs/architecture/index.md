...
- [`widget-compatibility.md`](widget-compatibility.md) — UE 5.7 public-API facade for Widget Blueprint creation, tree mutation, rename, variable exposure, and event binding.
