...
- [`blueprint-graph-editor.md`](blueprint-graph-editor.md) — transactional action-backed node creation, exact movement, safe removal, identity completion, and read-back.
