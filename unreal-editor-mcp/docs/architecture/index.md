...
- [`commonui-widget-inspection.md`](commonui-widget-inspection.md) — optional CommonUI companion ownership, Widget Blueprint defaults/references, integrated fingerprints, and read-only capability policy.
...
- [`asset-inspection-service.md`](asset-inspection-service.md) — exact `/Game` resolution, core-family semantic roots, selectors, paging, graph traversal, limits, and snapshots.
