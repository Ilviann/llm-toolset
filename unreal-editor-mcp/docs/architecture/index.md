...
- [`windows-deployment-helper.md`](windows-deployment-helper.md) — tkinter project/Engine selection, complete production-companion Win64 packaging, optional matching-PDB deployment, and LM Studio/Codex settings previews.
