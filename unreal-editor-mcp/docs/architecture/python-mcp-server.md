...
- `blueprint_graph_edit` has exact `add_node`, `move_node`, and `remove_node` shapes with stable graph/action/node identities and bounded integer positions.
