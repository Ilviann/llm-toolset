...
- Only the twelve prior commands plus `gameplay_framework_edit` appear in the tool catalog. Their descriptions cover every family published by the native policy.
