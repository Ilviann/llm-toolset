# Phase 21 — Optional durable editor restart
...
- Extend `editor_lifecycle` with a typed `restart` operation composed from the Phase 20 shutdown and Phase 19 launch contracts.
