...
- Treat the released property bindings as legacy `UWidgetBlueprint::Bindings` records and Designer events as graph-node bindings. Defer `UMVVMViewModelBase`, FieldNotify, ViewModel contexts, and UMG View Bindings to [`umg-mvvm`](../planned/umg-mvvm.md).
