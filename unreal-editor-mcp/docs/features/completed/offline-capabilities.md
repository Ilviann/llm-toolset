...
- The CLI injects that identity into the MCP server. Every `capabilities` success reports it with Python, negotiated-protocol, tool-mode, and lifecycle metadata.
