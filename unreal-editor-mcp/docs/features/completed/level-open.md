...
- Reuse the exact-snapshot infrastructure only with the resolved Windows canonicalization in [`issue-1`](../../issues/issue-1.md). Preserve meaningful structural differences rather than weakening equality checks.
