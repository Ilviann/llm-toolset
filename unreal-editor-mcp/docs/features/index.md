...
- [`windows-deployment-ai` — AI companion deployment](completed/windows-deployment-ai.md) — Include AI in independent companion selection and the complete five-plugin installation transaction.
  - Depends on:
