...
- Defer Gameplay Effect asset inspection and authoring to [`gas-gameplay-effects-inspect`](gas-gameplay-effects-inspect.md) and [`gas-gameplay-effects`](gas-gameplay-effects.md). Keep Attribute Set authoring, Gameplay Cue asset authoring, Ability System Component setup on Actors, input binding, project GAS configuration, runtime ability granting or activation, PIE execution, and arbitrary custom Ability Task or C++ generation outside this feature.
