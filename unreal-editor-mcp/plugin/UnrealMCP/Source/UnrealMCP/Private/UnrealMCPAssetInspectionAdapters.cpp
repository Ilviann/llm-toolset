    ...
    FUnrealMCPError& OutError)
{
    return Registry.Register(
            AssetInspectionAdaptersPrivate::Descriptor(
        ...
        && Registry.Register(
            AssetInspectionAdaptersPrivate::Descriptor(
                TEXT("neutral_asset"), UObject::StaticClass(),
                EUnrealMCPAssetFamilyClassPolicy::ExactAndDerived, 0,
                MakeShared<AssetInspectionAdaptersPrivate::FNeutralAssetInspectionAdapter>()),
            OutError);
}
