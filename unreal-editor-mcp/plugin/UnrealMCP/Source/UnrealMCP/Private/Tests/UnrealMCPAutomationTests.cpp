...
TSharedRef<FJsonObject> MacroSignature(bool bPure, const TArray<TSharedPtr<FJsonValue>>& Parameters)
{
    const TSharedRef<FJsonObject> Signature = MakeShared<FJsonObject>();
    Signature->SetBoolField(TEXT("pure"), bPure);
    Signature->SetArrayField(TEXT("parameters"), Parameters);
...
TSharedRef<FJsonObject> CustomEventParameter(
    const FString& Name,
    const TSharedRef<FJsonObject>& Type,
    const TSharedPtr<FJsonObject>& Default = nullptr)
{
...
TSharedRef<FJsonObject> CustomEventSignature(const TArray<TSharedPtr<FJsonValue>>& Parameters)
{
    const TSharedRef<FJsonObject> Signature = MakeShared<FJsonObject>();
    Signature->SetArrayField(TEXT("parameters"), Parameters);
    return Signature;
