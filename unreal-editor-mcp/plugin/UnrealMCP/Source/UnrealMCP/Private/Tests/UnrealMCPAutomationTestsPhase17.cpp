...
namespace
{
TSharedRef<FUnrealMCPRecord> DataArguments(const FString& Target, const FString& Operation, const FString& AssetPath)
{
...
TSharedRef<FUnrealMCPRecord> StructMember(const FString& Name, const FString& Category, const TSharedPtr<FUnrealMCPRecord>& Default)
{
    const TSharedRef<FUnrealMCPRecord> Result = MakeShared<FUnrealMCPRecord>(); Result->SetStringField(TEXT("name"), Name);
...
TSharedRef<FUnrealMCPRecord> Row(const FString& Name, int32 Damage, const FString& Ammo)
{
    const TSharedRef<FUnrealMCPRecord> Values = MakeShared<FUnrealMCPRecord>(); Values->SetNumberField(TEXT("Damage"), Damage); Values->SetStringField(TEXT("AmmoType"), Ammo);
    const TSharedRef<FUnrealMCPRecord> Result = MakeShared<FUnrealMCPRecord>(); Result->SetStringField(TEXT("row_name"), Name); Result->SetObjectField(TEXT("values"), Values); return Result;
}

bool Inspect(FUnrealMCPGameDataService& Service, const FString& Target, const FString& AssetPath, TSharedPtr<FUnrealMCPRecord>& Out, FUnrealMCPError& Error, int32 PageSize = 100)
{
    const TSharedRef<FUnrealMCPRecord> Arguments = MakeShared<FUnrealMCPRecord>(); Arguments->SetStringField(TEXT("target"), Target);
...
bool FUnrealMCPPhase17GameDataAuthoringTest::RunTest(const FString& Parameters)
{
    ...
    CreateStruct->SetArrayField(TEXT("members"), {
        MakeShared<FUnrealMCPValueObject>(StructMember(TEXT("Damage"), TEXT("int"), LiteralDefault(MakeShared<FUnrealMCPValueNumber>(25)))),
        MakeShared<FUnrealMCPValueObject>(StructMember(TEXT("AmmoType"), TEXT("string"), LiteralDefault(MakeShared<FUnrealMCPValueString>(TEXT("Rifle"))))) });
    ...
    TSharedRef<FUnrealMCPRecord> Rename = DataArguments(TEXT("user_defined_struct"), TEXT("rename_member"), StructPath);
    ...
    TSharedRef<FUnrealMCPRecord> CreateTable = DataArguments(TEXT("data_table"), TEXT("create"), TablePackage);
    CreateTable->SetStringField(TEXT("row_struct"), StructPath);
    const TSharedRef<FUnrealMCPRecord> PistolValues = MakeShared<FUnrealMCPRecord>(); PistolValues->SetNumberField(TEXT("BaseDamage"), 30); PistolValues->SetStringField(TEXT("AmmoType"), TEXT("Pistol"));
    const TSharedRef<FUnrealMCPRecord> Pistol = MakeShared<FUnrealMCPRecord>(); Pistol->SetStringField(TEXT("row_name"), TEXT("Pistol")); Pistol->SetObjectField(TEXT("values"), PistolValues);
    CreateTable->SetArrayField(TEXT("rows"), {MakeShared<FUnrealMCPValueObject>(Pistol)});
    ...
    TSharedRef<FUnrealMCPRecord> RemoveMember = DataArguments(TEXT("user_defined_struct"), TEXT("remove_member"), StructPath);
    ...
    TSharedRef<FUnrealMCPRecord> Add = DataArguments(TEXT("data_table"), TEXT("add_row"), TablePath); Add->SetStringField(TEXT("expected_snapshot"), TableSnapshot);
    Add->SetStringField(TEXT("row_name"), TEXT("Rifle")); const TSharedRef<FUnrealMCPRecord> RifleValues = MakeShared<FUnrealMCPRecord>(); RifleValues->SetNumberField(TEXT("BaseDamage"), 42); RifleValues->SetStringField(TEXT("AmmoType"), TEXT("Rifle")); Add->SetObjectField(TEXT("values"), RifleValues);
    ...
    TSharedRef<FUnrealMCPRecord> Batch = DataArguments(TEXT("data_table"), TEXT("batch"), TablePath); Batch->SetStringField(TEXT("expected_snapshot"), TableSnapshot);
    const TSharedRef<FUnrealMCPRecord> RiflePatchValues = MakeShared<FUnrealMCPRecord>(); RiflePatchValues->SetNumberField(TEXT("BaseDamage"), 45);
    const TSharedRef<FUnrealMCPRecord> RiflePatch = MakeShared<FUnrealMCPRecord>(); RiflePatch->SetStringField(TEXT("row_name"), TEXT("Rifle")); RiflePatch->SetObjectField(TEXT("values"), RiflePatchValues); RiflePatch->SetBoolField(TEXT("preserve_unspecified"), true);
    Batch->SetArrayField(TEXT("upserts"), {MakeShared<FUnrealMCPValueObject>(RiflePatch)}); Batch->SetArrayField(TEXT("remove_rows"), {MakeShared<FUnrealMCPValueString>(TEXT("Pistol"))});
    ...
    const TSharedPtr<FUnrealMCPRecord> Rifle = Result->GetArrayField(TEXT("records"))[0]->AsObject();
    ...
    TSharedRef<FUnrealMCPRecord> InvalidBatch = DataArguments(TEXT("data_table"), TEXT("batch"), TablePath); InvalidBatch->SetStringField(TEXT("expected_snapshot"), TableSnapshot);
    InvalidBatch->SetArrayField(TEXT("upserts"), {MakeShared<FUnrealMCPValueObject>(Row(TEXT("Rifle"), 1, TEXT("Rifle")))});
    InvalidBatch->SetArrayField(TEXT("remove_rows"), {MakeShared<FUnrealMCPValueString>(TEXT("rifle"))});
    ...
    TSharedRef<FUnrealMCPRecord> CreateNativeTable = DataArguments(TEXT("data_table"), TEXT("create"), NativeTablePackage);
    CreateNativeTable->SetStringField(TEXT("row_struct"), TEXT("/Script/Engine.MirrorTableRow"));
    const TSharedRef<FUnrealMCPRecord> NativeValues = MakeShared<FUnrealMCPRecord>(); NativeValues->SetStringField(TEXT("Name"), TEXT("hand_l"));
    NativeValues->SetStringField(TEXT("MirroredName"), TEXT("hand_r")); NativeValues->SetBoolField(TEXT("bEnabled"), true);
    const TSharedRef<FUnrealMCPRecord> NativeRow = MakeShared<FUnrealMCPRecord>(); NativeRow->SetStringField(TEXT("row_name"), TEXT("LeftHand")); NativeRow->SetObjectField(TEXT("values"), NativeValues);
    CreateNativeTable->SetArrayField(TEXT("rows"), {MakeShared<FUnrealMCPValueObject>(NativeRow)});
