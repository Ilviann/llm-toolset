    ...
    FUnrealMCPError& OutError)
{
    ...
    if (Kind == TEXT("panel"))
    {
        if (!UnrealMCP::BlueprintMutationPrivate::HasOnlyFields(**Target, {TEXT("kind"), TEXT("parent_id"), TEXT("index")}))
        {
    ...
    {
        if (!UnrealMCP::BlueprintMutationPrivate::HasOnlyFields(**Target, {TEXT("kind"), TEXT("slot_id")}))
        {
