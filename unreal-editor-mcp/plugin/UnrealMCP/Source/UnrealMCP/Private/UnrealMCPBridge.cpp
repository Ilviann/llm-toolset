...
TSharedPtr<FJsonObject> FUnrealMCPBridge::Capabilities() const
{
    ...
    Features->SetBoolField(TEXT("blueprint_interface_inspection"), true);
    Features->SetBoolField(TEXT("animation_blueprint_inspection"), true);
    Features->SetBoolField(TEXT("graph_scoped_inspection"), true);
