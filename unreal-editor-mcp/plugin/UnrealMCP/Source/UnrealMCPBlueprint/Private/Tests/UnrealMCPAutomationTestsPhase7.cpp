...
bool FUnrealMCPPhase7MacroAndCustomEventTest::RunTest(const FString& Parameters)
{
    ...
    const TArray<TSharedPtr<FUnrealMCPValue>> MacroParameters = {
        MakeShared<FUnrealMCPValueObject>(FunctionParameter(TEXT("Count"), TEXT("input"), K2Type(TEXT("int")),
            LiteralDefault(MakeShared<FUnrealMCPValueNumber>(2)))),
    ...
    const TSharedRef<FUnrealMCPRecord> MacroMetadata = MakeShared<FUnrealMCPRecord>();
    ...
    TSharedRef<FUnrealMCPRecord> CollidingEvent = ScopedMemberEditArguments(AssetPath, Snapshot, TEXT("custom_event"), TEXT("add"));
    ...
    TSharedRef<FUnrealMCPRecord> WrongGraphEvent = ScopedMemberEditArguments(AssetPath, Snapshot, TEXT("custom_event"), TEXT("add"));
    ...
    TSharedRef<FUnrealMCPRecord> AddEvent = ScopedMemberEditArguments(AssetPath, Snapshot, TEXT("custom_event"), TEXT("add"));
    ...
    AddEvent->SetObjectField(TEXT("signature"), CustomEventSignature({
        MakeShared<FUnrealMCPValueObject>(CustomEventParameter(TEXT("Threshold"), K2Type(TEXT("int")),
            LiteralDefault(MakeShared<FUnrealMCPValueNumber>(5))))}));
    const TSharedRef<FUnrealMCPRecord> EventMetadata = MakeShared<FUnrealMCPRecord>();
    ...
    TSharedRef<FUnrealMCPRecord> RenameMacro = ScopedMemberEditArguments(AssetPath, BeforeMacroRename, TEXT("macro"), TEXT("rename"));
    ...
    TSharedRef<FUnrealMCPRecord> RenameEvent = ScopedMemberEditArguments(AssetPath, AfterMacroRename, TEXT("custom_event"), TEXT("rename"));
    ...
    TSharedRef<FUnrealMCPRecord> UpdateMacro = ScopedMemberEditArguments(
    ...
    TSharedRef<FUnrealMCPRecord> UpdateEvent = ScopedMemberEditArguments(
    ...
    UpdateEvent->SetObjectField(TEXT("signature"), CustomEventSignature({
        MakeShared<FUnrealMCPValueObject>(CustomEventParameter(TEXT("Value"), K2Type(TEXT("string")),
            LiteralDefault(MakeShared<FUnrealMCPValueString>(TEXT("ready")))))}));
    ...
    TSharedRef<FUnrealMCPRecord> AddTemporaryMacro = ScopedMemberEditArguments(
    ...
    TSharedRef<FUnrealMCPRecord> RemoveTemporaryMacro = ScopedMemberEditArguments(
    ...
    TSharedRef<FUnrealMCPRecord> AddTemporaryEvent = ScopedMemberEditArguments(
    ...
    TSharedRef<FUnrealMCPRecord> RemoveTemporaryEvent = ScopedMemberEditArguments(
    ...
    TSharedRef<FUnrealMCPRecord> RemoveUsedMacro = ScopedMemberEditArguments(AssetPath, Snapshot, TEXT("macro"), TEXT("remove"));
    ...
    TSharedRef<FUnrealMCPRecord> RemoveUsedEvent = ScopedMemberEditArguments(AssetPath, Snapshot, TEXT("custom_event"), TEXT("remove"));
