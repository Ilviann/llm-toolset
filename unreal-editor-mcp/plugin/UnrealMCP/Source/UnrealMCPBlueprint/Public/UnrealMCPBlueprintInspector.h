...
class UNREALMCPBLUEPRINT_API FUnrealMCPBlueprintInspector
{
public:
    explicit FUnrealMCPBlueprintInspector(TFunction<double()> InNow = [] { return FPlatformTime::Seconds(); });
    FUnrealMCPBlueprintInspector(
        const IUnrealMCPBlueprintExtensionProvider& InExtensionRegistry,
...
private:
    ...
    const IUnrealMCPBlueprintExtensionProvider* ExtensionRegistry = nullptr;
