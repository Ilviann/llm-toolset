...
class ReleaseContractTests(unittest.TestCase):
    def test_versions_match_executable_metadata(self):
        ...
        self.assertEqual(versions, {"0.14.0"})

    def test_only_released_phase_fifteen_commands_are_registered(self):
    ...
    def test_phase_fifteen_family_policy_is_published_and_covered(self):
