...
- [`process-entry-composition.md`](process-entry-composition.md) — script/module/installed entry points, CLI parsing, composition, and host configuration previews.
...
- [`markdown-reading.md`](markdown-reading.md) — Markdown path fragments, generated heading anchors, exact section/front-matter extraction, and host-mode enforcement.
