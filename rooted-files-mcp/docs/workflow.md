...
4. Update changed architecture/type references and their immediate indexes. Update `README.md` for user-visible changes and `ROADMAP.md` or history for scope/release changes. From the repository root, run `python internal/tools/lint_docs.py` after Markdown changes.
