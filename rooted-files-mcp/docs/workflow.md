...
1. Start at [`index.md`](index.md). Read the owning architecture page, affected type indexes, and relevant [`todo/`](todo/index.md) feature document, then inspect the source, tests, metadata, examples, roadmap/history, and user documentation. Expand the working set only when evidence reveals another dependency.
