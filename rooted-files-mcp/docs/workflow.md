...
1. Start at [`index.md`](index.md). Read the owning architecture page and affected type indexes, then inspect the relevant source, tests, metadata, examples, roadmap/history, and user documentation. Expand the working set only when evidence reveals another dependency.
